...
#define __PYX_HAVE__post_process
#define __PYX_HAVE_API__post_process
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'post_process' */
...
static int __pyx_f_12post_process_argmax1D(__Pyx_memviewslice); /*proto*/
static void __pyx_f_12post_process_argmax4D(__Pyx_memviewslice, std::vector<int> , __Pyx_memviewslice); /*proto*/
static PyObject *__pyx_f_12post_process_postprocess_cython(PyArrayObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "post_process"
extern int __pyx_module_is_main_post_process;
int __pyx_module_is_main_post_process = 0;

/* Implementation of 'post_process' */
...
static const char __pyx_k_resized_imgs[] = "resized_imgs";
...
static PyObject *__pyx_n_s_resized_imgs;
...
static PyObject *__pyx_pf_12post_process_postprocess_cython(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_masks, PyObject *__pyx_v_pads, PyObject *__pyx_v_resized_imgs); /* proto */
...
static void __pyx_f_12post_process_argmax3D(__Pyx_memviewslice __pyx_v_array_1, std::vector<int>  __pyx_v_ignore_class, __Pyx_memviewslice __pyx_v_out) {
  Py_ssize_t __pyx_v_h_max;
  Py_ssize_t __pyx_v_w_max;
  int __pyx_v_tmp;
  Py_ssize_t __pyx_v_x;
  Py_ssize_t __pyx_v_y;
  Py_ssize_t __pyx_v_class_id;
 ...
 * 
 */
  __pyx_v_h_max = (__pyx_v_array_1.shape[1]);
 ...
 */
  __pyx_v_w_max = (__pyx_v_array_1.shape[2]);
 ...
 *                 if tmp == class_id:
 */
      __pyx_t_7.data = __pyx_v_array_1.data;
      __pyx_t_7.memview = __pyx_v_array_1.memview;
      __PYX_INC_MEMVIEW(&__pyx_t_7, 0);
      __pyx_t_7.shape[0] = __pyx_v_array_1.shape[0];
__pyx_t_7.strides[0] = __pyx_v_array_1.strides[0];
    __pyx_t_7.suboffsets[0] = -1;

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_x;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_array_1.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_array_1.strides[1];
        if (__pyx_tmp_idx < 0)
...

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_y;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_array_1.shape[2];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_array_1.strides[2];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_7.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_v_tmp = __pyx_f_12post_process_argmax1D(__pyx_t_7);
 ...
 *                     tmp = 0
 */
      __pyx_t_8 = __pyx_v_ignore_class.begin();
      for (;;) {
        if (!(__pyx_t_8 != __pyx_v_ignore_class.end())) break;
        __pyx_t_9 = *__pyx_t_8;
        ++__pyx_t_8;
        __pyx_v_class_id = __pyx_t_9;
 ...
 *             out[x, y] = tmp
 */
        __pyx_t_10 = ((__pyx_v_tmp == __pyx_v_class_id) != 0);
        if (__pyx_t_10) {
 ...
 */
      ...
      if (__pyx_t_12 < 0) __pyx_t_12 += __pyx_v_out.shape[1];
      *((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out.data + __pyx_t_11 * __pyx_v_out.strides[0]) ) + __pyx_t_12 * __pyx_v_out.strides[1]) )) = __pyx_v_tmp;
    }
  }
...
static int __pyx_f_12post_process_argmax1D(__Pyx_memviewslice __pyx_v_l) {
  int __pyx_v_index;
 ...
 *             index, max_val = i, l[i]
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_l); 
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;
 ...
 */
    ...
    __pyx_t_5 = (((*((float *) ( /* dim=0 */ (__pyx_v_l.data + __pyx_t_4 * __pyx_v_l.strides[0]) ))) > __pyx_v_max_val) != 0);
    if (__pyx_t_5) {
 ...
 */
      ...
      __pyx_t_4 = __pyx_v_i;
      if (__pyx_t_4 < 0) __pyx_t_4 += __pyx_v_l.shape[0];
      __pyx_t_7 = (*((float *) ( /* dim=0 */ (__pyx_v_l.data + __pyx_t_4 * __pyx_v_l.strides[0]) )));
...
static void __pyx_f_12post_process_argmax4D(__Pyx_memviewslice __pyx_v_batch_img, std::vector<int>  __pyx_v_ignore_class, __Pyx_memviewslice __pyx_v_out) {
 ...
 */
  __pyx_v_N = (__pyx_v_batch_img.shape[0]);
 ...
 * 
 */
  __pyx_v_h_max = (__pyx_v_batch_img.shape[2]);
 ...
 *     # view.array(shape=(360, 640), itemsize=sizeof(unsigned char), format="i")
 */
  __pyx_v_w_max = (__pyx_v_batch_img.shape[3]);
 ...
 */
  ...
  if ((1 == 0)) abort();
  {
      ...
      {
          #ifdef _OPENMP
          #pragma omp parallel private(__pyx_t_11, __pyx_t_12, __pyx_t_13, __pyx_t_14, __pyx_t_15, __pyx_t_16, __pyx_t_4, __pyx_t_5, __pyx_t_6, __pyx_t_7, __pyx_t_8, __pyx_t_9) firstprivate(__pyx_t_10)
          #endif /* _OPENMP */
          {
              #ifdef _OPENMP
              #pragma omp for lastprivate(__pyx_v_class_id) firstprivate(__pyx_v_n) lastprivate(__pyx_v_n) lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_x) lastprivate(__pyx_v_y)
              #endif /* _OPENMP */
              for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_3; __pyx_t_2++){
                  {
                      __pyx_v_n = (Py_ssize_t)(0 + 1 * __pyx_t_2);
                      /* Initialize private variables to invalid values */
                      __pyx_v_class_id = ((Py_ssize_t)0xbad0bad0);
 ...
 *                     if tmp == class_id:
 */
                          __pyx_t_10.data = __pyx_v_batch_img.data;
                          __pyx_t_10.memview = __pyx_v_batch_img.memview;
                          __PYX_INC_MEMVIEW(&__pyx_t_10, 0);
                          {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_n;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_batch_img.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_batch_img.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_10.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_10.shape[0] = __pyx_v_batch_img.shape[1];
__pyx_t_10.strides[0] = __pyx_v_batch_img.strides[1];
    __pyx_t_10.suboffsets[0] = -1;

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_x;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_batch_img.shape[2];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_batch_img.strides[2];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_10.data += __pyx_tmp_idx * __pyx_tmp_stride;
}
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_y;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_batch_img.shape[3];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_batch_img.strides[3];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        __pyx_t_10.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_v_tmp = __pyx_f_12post_process_argmax1D(__pyx_t_10);
 ...
 *                         tmp = 0
 */
                          __pyx_t_11 = __pyx_v_ignore_class.begin();
                          for (;;) {
                            if (!(__pyx_t_11 != __pyx_v_ignore_class.end())) break;
                            __pyx_t_12 = *__pyx_t_11;
                            ++__pyx_t_11;
                            __pyx_v_class_id = __pyx_t_12;
 ...
 *                 out[n, x, y] = tmp
 */
                            __pyx_t_13 = ((__pyx_v_tmp == __pyx_v_class_id) != 0);
                            if (__pyx_t_13) {
 ...
 */
                          ...
                          if (__pyx_t_16 < 0) __pyx_t_16 += __pyx_v_out.shape[2];
                          *((unsigned char *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_out.data + __pyx_t_14 * __pyx_v_out.strides[0]) ) + __pyx_t_15 * __pyx_v_out.strides[1]) ) + __pyx_t_16 * __pyx_v_out.strides[2]) )) = __pyx_v_tmp;
                        }
                      }
                  }
              }
...
static PyObject *__pyx_pw_12post_process_1postprocess_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_12post_process_postprocess_cython(PyArrayObject *__pyx_v_masks, PyObject *__pyx_v_pads, PyObject *__pyx_v_resized_imgs, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  int __pyx_v_C;
  int __pyx_v_N_;
  int __pyx_v_C_;
  int __pyx_v_net_h;
  int __pyx_v_net_w;
  PyArrayObject *__pyx_v_mask_batch_ = 0;
  PyArrayObject *__pyx_v_mask_argmax_batch = 0;
  __Pyx_memviewslice __pyx_v_mask_argmax_batch_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyArrayObject *__pyx_v_mask = 0;
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_my_out = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_output_list = 0;
  int __pyx_v_top_pad;
  int __pyx_v_left_pad;
  int __pyx_v_h;
  int __pyx_v_w;
  PyObject *__pyx_v_img = NULL;
  PyObject *__pyx_v_class_ = NULL;
  __Pyx_memviewslice __pyx_v_mask_batch = { 0, 0, { 0 }, { 0 }, { 0 } };
  std::vector<int>  __pyx_v_ignore_class;
  Py_ssize_t __pyx_v_idx;
  PyObject *__pyx_v_pad = NULL;
  CYTHON_UNUSED PyObject *__pyx_v__ = NULL;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mask_batch_;
  __Pyx_Buffer __pyx_pybuffer_mask_batch_;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("postprocess_cython", 0);
  __pyx_pybuffer_mask_batch_.pybuffer.buf = NULL;
  __pyx_pybuffer_mask_batch_.refcount = 0;
  __pyx_pybuffernd_mask_batch_.data = NULL;
  __pyx_pybuffernd_mask_batch_.rcbuffer = &__pyx_pybuffer_mask_batch_;
 ...
 *     cdef int N_, C_
 */
  __pyx_v_N = (__pyx_v_masks->dimensions[0]);
 ...
 */
  __pyx_v_C = (__pyx_v_masks->dimensions[1]);
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_ndarray); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 93, __pyx_L1_error)
  ...
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_net_h); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_net_w); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = PyTuple_New(4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 93, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 93, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_3);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 4, 0, __pyx_stack) == -1)) {
      __pyx_v_mask_batch_ = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 93, __pyx_L1_error)
    } else {__pyx_pybuffernd_mask_batch_.diminfo[0].strides = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_mask_batch_.diminfo[0].shape = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_mask_batch_.diminfo[1].strides = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_mask_batch_.diminfo[1].shape = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_mask_batch_.diminfo[2].strides = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_mask_batch_.diminfo[2].shape = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.shape[2]; __pyx_pybuffernd_mask_batch_.diminfo[3].strides = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.strides[3]; __pyx_pybuffernd_mask_batch_.diminfo[3].shape = __pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer.shape[3];
    }
  }
  __pyx_t_7 = 0;
  __pyx_v_mask_batch_ = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_net_h); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_net_w); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_uint8); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_2, __pyx_t_4); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 94, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (!(likely(((__pyx_t_3) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_3, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 94, __pyx_L1_error)
  __pyx_v_mask_argmax_batch = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;
 ...
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_unsigned_char(((PyObject *)__pyx_v_mask_argmax_batch), PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 95, __pyx_L1_error)
  __pyx_v_mask_argmax_batch_view = __pyx_t_8;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_net_h); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_net_w); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_uint8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_5) < 0) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 96, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(((PyObject *)__pyx_v_mask), PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 97, __pyx_L1_error)
  __pyx_v_my_out = __pyx_t_9;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_v_output_list = ((PyObject*)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "post_process.pyx":101
 *     cdef int top_pad, left_pad, h, w
 * 
 ...
 */
  __pyx_t_5 = PyObject_RichCompare(((PyObject *)__pyx_v_masks), __pyx_float_0_5, Py_LT); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 101, __pyx_L1_error)
  if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_masks), __pyx_t_5, __pyx_int_neg_100) < 0)) __PYX_ERR(0, 101, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;

  /* "post_process.pyx":102
 * 
 *     masks[masks < 0.5] = -100  # can be zero / -ve value
 *     for N_, img in enumerate(masks):             # <<<<<<<<<<<<<<
 *         for C_, class_ in enumerate(img):
 ...
 */
  __pyx_t_10 = 0;
  if (likely(PyList_CheckExact(((PyObject *)__pyx_v_masks))) || PyTuple_CheckExact(((PyObject *)__pyx_v_masks))) {
    __pyx_t_5 = ((PyObject *)__pyx_v_masks); __Pyx_INCREF(__pyx_t_5); __pyx_t_11 = 0;
    __pyx_t_12 = NULL;
  } else {
    __pyx_t_11 = -1; __pyx_t_5 = PyObject_GetIter(((PyObject *)__pyx_v_masks)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 102, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_12 = Py_TYPE(__pyx_t_5)->tp_iternext; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 102, __pyx_L1_error)
  }
  for (;;) {
    if (likely(!__pyx_t_12)) {
      if (likely(PyList_CheckExact(__pyx_t_5))) {
        ...
        __pyx_t_6 = PyList_GET_ITEM(__pyx_t_5, __pyx_t_11); __Pyx_INCREF(__pyx_t_6); __pyx_t_11++; if (unlikely(0 < 0)) __PYX_ERR(0, 102, __pyx_L1_error)
        #else
        __pyx_t_6 = PySequence_ITEM(__pyx_t_5, __pyx_t_11); __pyx_t_11++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 102, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        #endif
      } else {
        if (__pyx_t_11 >= PyTuple_GET_SIZE(__pyx_t_5)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_6 = PyTuple_GET_ITEM(__pyx_t_5, __pyx_t_11); __Pyx_INCREF(__pyx_t_6); __pyx_t_11++; if (unlikely(0 < 0)) __PYX_ERR(0, 102, __pyx_L1_error)
        #else
        __pyx_t_6 = PySequence_ITEM(__pyx_t_5, __pyx_t_11); __pyx_t_11++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 102, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        #endif
    ...
    __pyx_t_6 = 0;
    __pyx_v_N_ = __pyx_t_10;
    __pyx_t_10 = (__pyx_t_10 + 1);

    /* "post_process.pyx":103
 *     masks[masks < 0.5] = -100  # can be zero / -ve value
 *     for N_, img in enumerate(masks):
 *         for C_, class_ in enumerate(img):             # <<<<<<<<<<<<<<
 *             mask_batch_[N_][C_] = cv2.resize(class_, (net_w, net_h), interpolation=cv2.INTER_LINEAR)
 ...
 */
    __pyx_t_13 = 0;
    if (likely(PyList_CheckExact(__pyx_v_img)) || PyTuple_CheckExact(__pyx_v_img)) {
      __pyx_t_6 = __pyx_v_img; __Pyx_INCREF(__pyx_t_6); __pyx_t_14 = 0;
      __pyx_t_15 = NULL;
    } else {
      __pyx_t_14 = -1; __pyx_t_6 = PyObject_GetIter(__pyx_v_img); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 103, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_15 = Py_TYPE(__pyx_t_6)->tp_iternext; if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 103, __pyx_L1_error)
    }
    for (;;) {
      if (likely(!__pyx_t_15)) {
        if (likely(PyList_CheckExact(__pyx_t_6))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_2 = PyList_GET_ITEM(__pyx_t_6, __pyx_t_14); __Pyx_INCREF(__pyx_t_2); __pyx_t_14++; if (unlikely(0 < 0)) __PYX_ERR(0, 103, __pyx_L1_error)
          #else
          __pyx_t_2 = PySequence_ITEM(__pyx_t_6, __pyx_t_14); __pyx_t_14++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 103, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          #endif
        } else {
          if (__pyx_t_14 >= PyTuple_GET_SIZE(__pyx_t_6)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_2 = PyTuple_GET_ITEM(__pyx_t_6, __pyx_t_14); __Pyx_INCREF(__pyx_t_2); __pyx_t_14++; if (unlikely(0 < 0)) __PYX_ERR(0, 103, __pyx_L1_error)
          #else
          __pyx_t_2 = PySequence_ITEM(__pyx_t_6, __pyx_t_14); __pyx_t_14++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 103, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          #endif
      ...
      __Pyx_XDECREF_SET(__pyx_v_class_, __pyx_t_2);
      __pyx_t_2 = 0;
      __pyx_v_C_ = __pyx_t_13;
      __pyx_t_13 = (__pyx_t_13 + 1);

      /* "post_process.pyx":104
 *     for N_, img in enumerate(masks):
 *         for C_, class_ in enumerate(img):
 *             mask_batch_[N_][C_] = cv2.resize(class_, (net_w, net_h), interpolation=cv2.INTER_LINEAR)             # <<<<<<<<<<<<<<
 *     cdef float[:,:,:,::1] mask_batch = mask_batch_
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_resize); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_net_w); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_net_h); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_cv2); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_16 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_INTER_LINEAR); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_interpolation, __pyx_t_16) < 0) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
      __pyx_t_16 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_3, __pyx_t_1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_1 = __Pyx_GetItemInt(((PyObject *)__pyx_v_mask_batch_), __pyx_v_N_, int, 1, __Pyx_PyInt_From_int, 0, 1, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      if (unlikely(__Pyx_SetItemInt(__pyx_t_1, __pyx_v_C_, __pyx_t_16, int, 1, __Pyx_PyInt_From_int, 0, 1, 0) < 0)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
 ...
 */
  __pyx_t_17 = __Pyx_PyObject_to_MemoryviewSlice_d_d_d_dc_float(((PyObject *)__pyx_v_mask_batch_), PyBUF_WRITABLE); if (unlikely(!__pyx_t_17.memview)) __PYX_ERR(0, 105, __pyx_L1_error)
  __pyx_v_mask_batch = __pyx_t_17;
  __pyx_t_17.memview = NULL;
  __pyx_t_17.data = NULL;

  /* "post_process.pyx":107
 *     cdef float[:,:,:,::1] mask_batch = mask_batch_
 * 
 *     cdef vector[int] ignore_class = [0,1,2,3,4,5,9,10,13,14,15,16,17,18]             # <<<<<<<<<<<<<<
 * 
 *     cdef Py_ssize_t i
 */
  __pyx_t_5 = PyList_New(14); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 107, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  PyList_SET_ITEM(__pyx_t_5, 8, __pyx_int_13);
  __Pyx_INCREF(__pyx_int_14);
  __Pyx_GIVEREF(__pyx_int_14);
  PyList_SET_ITEM(__pyx_t_5, 9, __pyx_int_14);
  __Pyx_INCREF(__pyx_int_15);
  __Pyx_GIVEREF(__pyx_int_15);
  PyList_SET_ITEM(__pyx_t_5, 10, __pyx_int_15);
  __Pyx_INCREF(__pyx_int_16);
  __Pyx_GIVEREF(__pyx_int_16);
  PyList_SET_ITEM(__pyx_t_5, 11, __pyx_int_16);
  __Pyx_INCREF(__pyx_int_17);
  __Pyx_GIVEREF(__pyx_int_17);
  PyList_SET_ITEM(__pyx_t_5, 12, __pyx_int_17);
  __Pyx_INCREF(__pyx_int_18);
  __Pyx_GIVEREF(__pyx_int_18);
  PyList_SET_ITEM(__pyx_t_5, 13, __pyx_int_18);
  __pyx_t_18 = __pyx_convert_vector_from_py_int(__pyx_t_5); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 107, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_ignore_class = __pyx_t_18;

  /* "post_process.pyx":116
 ...
 * 
 */
        __pyx_f_12post_process_argmax4D(__pyx_v_mask_batch, __pyx_v_ignore_class, __pyx_v_mask_argmax_batch_view);
      }
 ...
 */
  __pyx_t_11 = 0;
  __pyx_t_5 = __pyx_v_pads; __Pyx_INCREF(__pyx_t_5); __pyx_t_14 = 0;
  for (;;) {
    if (__pyx_t_14 >= PyList_GET_SIZE(__pyx_t_5)) break;
    #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
    __pyx_t_6 = PyList_GET_ITEM(__pyx_t_5, __pyx_t_14); __Pyx_INCREF(__pyx_t_6); __pyx_t_14++; if (unlikely(0 < 0)) __PYX_ERR(0, 121, __pyx_L1_error)
    #else
    __pyx_t_6 = PySequence_ITEM(__pyx_t_5, __pyx_t_14); __pyx_t_14++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 121, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    #endif
    __Pyx_XDECREF_SET(__pyx_v_pad, __pyx_t_6);
    __pyx_t_6 = 0;
    __pyx_v_idx = __pyx_t_11;
    __pyx_t_11 = (__pyx_t_11 + 1);

    /* "post_process.pyx":122
 *     # del padding
 *     for idx, pad in enumerate(pads):
 *         top_pad, left_pad, = pad             # <<<<<<<<<<<<<<
 *         h, w, _ = resized_imgs[idx].shape
 *         if top_pad:
 */
    if ((likely(PyTuple_CheckExact(__pyx_v_pad))) || (PyList_CheckExact(__pyx_v_pad))) {
      ...
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_16 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      #endif
    } else {
      Py_ssize_t index = -1;
      __pyx_t_1 = PyObject_GetIter(__pyx_v_pad); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 122, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_19 = Py_TYPE(__pyx_t_1)->tp_iternext;
      index = 0; __pyx_t_6 = __pyx_t_19(__pyx_t_1); if (unlikely(!__pyx_t_6)) goto __pyx_L12_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_6);
      index = 1; __pyx_t_16 = __pyx_t_19(__pyx_t_1); if (unlikely(!__pyx_t_16)) goto __pyx_L12_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_16);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_19(__pyx_t_1), 2) < 0) __PYX_ERR(0, 122, __pyx_L1_error)
      __pyx_t_19 = NULL;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    ...
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_13 = __Pyx_PyInt_As_int(__pyx_t_16); if (unlikely((__pyx_t_13 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 122, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    __pyx_v_top_pad = __pyx_t_10;
    __pyx_v_left_pad = __pyx_t_13;

    /* "post_process.pyx":123
 *     for idx, pad in enumerate(pads):
 *         top_pad, left_pad, = pad
 *         h, w, _ = resized_imgs[idx].shape             # <<<<<<<<<<<<<<
 *         if top_pad:
 ...
 */
    if (unlikely(__pyx_v_resized_imgs == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
      __PYX_ERR(0, 123, __pyx_L1_error)
    }
    __pyx_t_16 = __Pyx_GetItemInt_List(__pyx_v_resized_imgs, __pyx_v_idx, Py_ssize_t, 1, PyInt_FromSsize_t, 1, 1, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_16);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_16, __pyx_n_s_shape); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    if ((likely(PyTuple_CheckExact(__pyx_t_6))) || (PyList_CheckExact(__pyx_t_6))) {
      ...
      #else
      __pyx_t_16 = PySequence_ITEM(sequence, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 123, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __pyx_t_1 = PySequence_ITEM(sequence, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 123, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      ...
      Py_ssize_t index = -1;
      __pyx_t_4 = PyObject_GetIter(__pyx_t_6); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 123, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_19 = Py_TYPE(__pyx_t_4)->tp_iternext;
      index = 0; __pyx_t_16 = __pyx_t_19(__pyx_t_4); if (unlikely(!__pyx_t_16)) goto __pyx_L14_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_16);
      index = 1; __pyx_t_1 = __pyx_t_19(__pyx_t_4); if (unlikely(!__pyx_t_1)) goto __pyx_L14_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_1);
      index = 2; __pyx_t_3 = __pyx_t_19(__pyx_t_4); if (unlikely(!__pyx_t_3)) goto __pyx_L14_unpacking_failed;
      __Pyx_GOTREF(__pyx_t_3);
      if (__Pyx_IternextUnpackEndCheck(__pyx_t_19(__pyx_t_4), 3) < 0) __PYX_ERR(0, 123, __pyx_L1_error)
      __pyx_t_19 = NULL;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_13 = __Pyx_PyInt_As_int(__pyx_t_16); if (unlikely((__pyx_t_13 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
    __pyx_t_10 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_10 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *         else:
 */
    __pyx_t_20 = (__pyx_v_top_pad != 0);
    if (__pyx_t_20) {

      /* "post_process.pyx":125
 *         h, w, _ = resized_imgs[idx].shape
 *         if top_pad:
 *             output_list.append(mask_argmax_batch[idx][top_pad:top_pad + h, :]) # top pad             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
      __pyx_t_6 = __Pyx_GetItemInt(((PyObject *)__pyx_v_mask_argmax_batch), __pyx_v_idx, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_top_pad); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_1 = __Pyx_PyInt_From_int((__pyx_v_top_pad + __pyx_v_h)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_16 = PySlice_New(__pyx_t_3, __pyx_t_1, Py_None); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      ...
      __pyx_t_16 = 0;
      __pyx_t_16 = __Pyx_PyObject_GetItem(__pyx_t_6, __pyx_t_1); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_21 = __Pyx_PyList_Append(__pyx_v_output_list, __pyx_t_16); if (unlikely(__pyx_t_21 == ((int)-1))) __PYX_ERR(0, 125, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
 ...
 */
    /*else*/ {
      __pyx_t_16 = __Pyx_GetItemInt(((PyObject *)__pyx_v_mask_argmax_batch), __pyx_v_idx, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 127, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_16);
      __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_left_pad); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 127, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_6 = __Pyx_PyInt_From_int((__pyx_v_left_pad + __pyx_v_w)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 127, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_3 = PySlice_New(__pyx_t_1, __pyx_t_6, Py_None); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 127, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      ...
      PyTuple_SET_ITEM(__pyx_t_6, 1, __pyx_t_3);
      __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyObject_GetItem(__pyx_t_16, __pyx_t_6); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 127, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_21 = __Pyx_PyList_Append(__pyx_v_output_list, __pyx_t_3); if (unlikely(__pyx_t_21 == ((int)-1))) __PYX_ERR(0, 127, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    }
    __pyx_L16:;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("post_process.postprocess_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_mask_batch_.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_mask_batch_);
  __Pyx_XDECREF((PyObject *)__pyx_v_mask_argmax_batch);
  __PYX_XDEC_MEMVIEW(&__pyx_v_mask_argmax_batch_view, 1);
  __Pyx_XDECREF((PyObject *)__pyx_v_mask);
  __PYX_XDEC_MEMVIEW(&__pyx_v_my_out, 1);
  __Pyx_XDECREF(__pyx_v_output_list);
  __Pyx_XDECREF(__pyx_v_img);
  __Pyx_XDECREF(__pyx_v_class_);
  __PYX_XDEC_MEMVIEW(&__pyx_v_mask_batch, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_12post_process_1postprocess_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_12post_process_1postprocess_cython(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_masks = 0;
  PyObject *__pyx_v_pads = 0;
  PyObject *__pyx_v_resized_imgs = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("postprocess_cython (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_masks,&__pyx_n_s_pads,&__pyx_n_s_resized_imgs,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_masks)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("postprocess_cython", 1, 3, 3, 1); __PYX_ERR(0, 81, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_resized_imgs)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("postprocess_cython", 1, 3, 3, 2); __PYX_ERR(0, 81, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "postprocess_cython") < 0)) __PYX_ERR(0, 81, __pyx_L3_error)
      }
    ...
    __pyx_v_masks = ((PyArrayObject *)values[0]);
    __pyx_v_pads = ((PyObject*)values[1]);
    __pyx_v_resized_imgs = ((PyObject*)values[2]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("postprocess_cython", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 81, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("post_process.postprocess_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_masks), __pyx_ptype_5numpy_ndarray, 1, "masks", 0))) __PYX_ERR(0, 81, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_pads), (&PyList_Type), 1, "pads", 1))) __PYX_ERR(0, 81, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_resized_imgs), (&PyList_Type), 1, "resized_imgs", 1))) __PYX_ERR(0, 81, __pyx_L1_error)
  __pyx_r = __pyx_pf_12post_process_postprocess_cython(__pyx_self, __pyx_v_masks, __pyx_v_pads, __pyx_v_resized_imgs);
...
static PyObject *__pyx_pf_12post_process_postprocess_cython(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_masks, PyObject *__pyx_v_pads, PyObject *__pyx_v_resized_imgs) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("postprocess_cython", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_12post_process_postprocess_cython(__pyx_v_masks, __pyx_v_pads, __pyx_v_resized_imgs, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 81, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "post_process.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "post_process._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"postprocess_cython", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_12post_process_1postprocess_cython, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_post_process(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_post_process},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_resized_imgs, __pyx_k_resized_imgs, sizeof(__pyx_k_resized_imgs), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initpost_process(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initpost_process(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_post_process(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_post_process(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_post_process(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'post_process' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_post_process(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("post_process", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_post_process) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "post_process")) {
      if (unlikely(PyDict_SetItemString(modules, "post_process", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init post_process", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init post_process");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
